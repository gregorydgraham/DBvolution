...
public class Options {
  ...
  public Options(DBDatabase database, String packageName, Long versionNumber, PrimaryKeyRecognisor pkRecog, ForeignKeyRecognisor fkRecog, Boolean trimCharColumns, Boolean includeForeignKeyColumnName, boolean compileImmediately, String... objectTypes) {
  ...
  public Options(Long versionNumber, PrimaryKeyRecognisor pkRecog, ForeignKeyRecognisor fkRecog, Boolean trimCharColumns) {
    this(null, "", versionNumber, pkRecog, fkRecog, trimCharColumns, false, true);
  }
  ...
  public Options setCompileImmediately(boolean b) {
    this.compileImmediately = b;
    return this;
  }
