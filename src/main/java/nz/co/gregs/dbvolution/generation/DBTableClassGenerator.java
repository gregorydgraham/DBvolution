...
public class DBTableClassGenerator {
     ...
     * @param packageName packageName
     * @param baseDirectory baseDirectory
     * @param fkRecog fkRecog an object that can recognize foreign key columns
     * by the column name and derive the related table
     * @param versionNumber versionNumber
     * @param pkRecog pkRecog an object that can recognize primary key columns
     * by the column name
     * @throws java.sql.SQLException java.sql.SQLException
     * @throws java.io.FileNotFoundException java.io.FileNotFoundException
     * @throws java.io.IOException java.io.IOException
...
//                        ResultSet foreignKeysRS = metaData.getExportedKeys(catalog, schema, dbTableClass.getTableName());
