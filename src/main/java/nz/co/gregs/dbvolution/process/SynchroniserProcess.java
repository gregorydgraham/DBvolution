 ...
 */
public class SynchroniserProcess extends ClusterProcess {

  private static final Log LOG = LogFactory.getLog(SynchroniserProcess.class);
  ...
  public String process() throws Exception {
    final DBDatabaseCluster cluster = getCluster();
    if (cluster != null) {
      try {
        // DO THE ACTUAL WORK
