...
public class DBCreateDatabase extends DBAction {
	...
	public <R extends DBRow> DBCreateDatabase(String databaseName) {
	...
	protected DBActionList getRevertDBActionList() {
		...
		reverts.add(new DBDropDatabase(databaseName));
		return reverts;
	}
	...
	public List<String> getSQLStatements(DBDatabase db) {
		...
		String sqlString = db.getDefinition().getCreateDatabase(db.getDatabaseName());
