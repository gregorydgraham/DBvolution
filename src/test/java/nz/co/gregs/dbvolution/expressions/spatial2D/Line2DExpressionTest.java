...
public class Line2DExpressionTest extends AbstractTest {
	...
	public static class LineTestTable extends DBRow {
		...
		@DBColumn
		public DBPoint2D crossing = this.column(this.line).intersectionWith(MultiPoint2DExpression.value(new Coordinate(3, 3), new Coordinate(2, 4), new Coordinate(1, 4))).asExpressionColumn();
	}
	...
	public void testValue() throws SQLException {
		...
		assertThat(allRows.get(0).line.jtsLineStringValue(), is(point));
	}
